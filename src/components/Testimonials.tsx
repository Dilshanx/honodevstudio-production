...
//         </motion.div>
//         <motion.blockquote
//           className='text-white/90 text-base lg:text-lg leading-relaxed mb-6 lg:mb-8 italic'
//           initial={shouldReduceMotion ? {} : { opacity: 0, y: 20 }}
//           animate={
//             shouldReduceMotion
//               ? {}
...
//           </motion.div>
//           <div>
//             <h4 className='text-white font-bold text-lg lg:text-xl group-hover:text-[#E7FF1A] transition-colors duration-300'>
//               {testimonial.name}
//             </h4>
...
//               <motion.button
//                 onClick={() => setIsAutoPlaying(!isAutoPlaying)}
//                 className={`text-xs lg:text-sm px-3 py-1 rounded-full border transition-all duration-300 ${
//                   isAutoPlaying
//                     ? "text-[#E7FF1A] border-[#E7FF1A]/30 bg-[#E7FF1A]/10"
//                     : "text-white/60 border-white/20 hover:text-white/80"
//                 }`}
