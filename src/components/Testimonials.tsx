...
const testimonials = [
  ...
  },
  {
    ...
    role: "Marketing Director, Nexus Corp",
    company: "Nexus Corp",
    image: "/images/testimonials/emily-watson.png",
    rating: 5,
    quote:
      "From concept to execution, they delivered beyond what we imagined. The user experience they created is simply phenomenal.",
  },
  ...
  },
  {
    ...
    role: "Product Manager, StartupX",
    company: "StartupX",
    image: "/images/testimonials/lisa-thompson.png",
    rating: 5,
    quote:
      "The collaboration was seamless, and the results speak for themselves. They truly understand what it takes to build exceptional digital experiences.",
  },
...
const TestimonialCard = ({
  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-4 bg-gradient-to-r from-blue-400/20 via-indigo-400/20 to-violet-400/20 rounded-[2.5rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl scale-105' />

      {/* Main Glass Card */}
      <div className='relative rounded-[2.5rem] bg-white/60 backdrop-blur-xl border border-white/80 shadow-xl shadow-blue-900/5 hover:shadow-2xl hover:bg-white/70 transition-all duration-500 p-8 lg:p-12'>
        {/* Quote Icon */}
        <motion.div
          className='absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/20'
          initial={shouldReduceMotion ? {} : { scale: 0, rotate: -180 }}
          animate={
            shouldReduceMotion
              ? {}
        ...
        {/* Stars */}
        <motion.div
          className='flex gap-1 mb-6 lg:mb-8 justify-center sm:justify-start'
          initial={shouldReduceMotion ? {} : { opacity: 0, y: 10 }}
          animate={
            shouldReduceMotion
              ? {}
        ...
        {/* Quote Text */}
        <motion.blockquote
          className='text-slate-700 leading-relaxed mb-8 lg:mb-10 text-lg md:text-xl font-medium text-center sm:text-left'
          initial={shouldReduceMotion ? {} : { opacity: 0, y: 20 }}
          animate={
            shouldReduceMotion
              ? {}
        ...
        {/* User Profile */}
        <motion.div
          className='flex flex-col sm:flex-row items-center gap-4 border-t border-slate-200/60 pt-6'
          initial={shouldReduceMotion ? {} : { opacity: 0, x: -20 }}
          animate={
            shouldReduceMotion
              ? {}
        ...
        >
          <motion.div
            className='relative w-14 h-14 lg:w-16 lg:h-16 rounded-full overflow-hidden border-2 border-white shadow-md'
            whileHover={shouldReduceMotion ? {} : { scale: 1.1 }}
            transition={{ type: "spring", stiffness: 400, damping: 25 }}
          >
            <Image
          ...
          <div className='text-center sm:text-left'>
            <h4 className='text-slate-900 font-bold text-lg group-hover:text-blue-600 transition-colors duration-300'>
              {testimonial.name}
            </h4>
  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0 z-0 pointer-events-none'>
        ...
        <motion.div
          style={{ x: dx, y: dy }}
          className='absolute top-[30%] left-[-5%] w-[40%] h-[40%] bg-white/40 rounded-full blur-[80px]'
        />
      ...
      <div className='container mx-auto px-4 md:px-8 relative z-10'>
        ...
        >
          ...
          <div className='text-center mb-12 lg:mb-16'>
            ...
            >
              <span className='block'>What Clients</span>
            ...
            <div className='flex flex-col items-center gap-6'>
              ...
              <div className='flex items-center gap-6 lg:gap-8'>
                <motion.button
                  ...
                  className='group p-3 rounded-full bg-white/40 border border-white/60 backdrop-blur-md hover:bg-white/80 hover:border-white shadow-sm transition-all duration-300 text-slate-700 hover:text-blue-600'
