...
//               <div className='absolute inset-0 bg-gradient-to-r from-[#E7FF1A] via-violet-400 to-cyan-400 rounded-3xl opacity-20 group-hover:opacity-30 transition-opacity duration-500 blur-xl scale-110' />
