...
// Modern 2025 Next.js CTA Component - Clean/3D Pastel Theme
export function CallToAction(): React.JSX.Element {
  // Simple scroll handler for portfolio
  const scrollToPortfolio = () => {
    const element = document.getElementById("work");
  ...
  return (
    <section
      id='cta'
      className='relative w-full bg-[#E0F2FE] py-20 lg:py-32 overflow-hidden'
    >
      {/* --- Background Pattern --- */}
      <div className='absolute inset-0 z-0 pointer-events-none'>
        {/* Soft Blobs */}
        <div className='absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-white/40 rounded-full blur-[120px]' />
        ...
        <div className='max-w-5xl mx-auto'>
          ...
          <div className='flex justify-center mb-8 md:mb-12'>
            <div className='relative group'>
              ...
              <div className='absolute inset-0 bg-gradient-to-r from-blue-400/30 via-indigo-400/30 to-violet-400/30 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-3xl scale-125' />

              <div className='relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 transition-transform duration-300 group-hover:scale-105 group-hover:-translate-y-2'>
                {/* NOTE: Ensure your /images/cta.svg works on a light background. 
                    If not, wrap it in a white circle or use a drop-shadow.
                 */}
                <Image
                  src='/images/cta.svg'
                  alt='Call to Action'
          ...
          <div className='text-center mb-12 lg:mb-16'>
            {/* Badge */}
            <div className='inline-flex items-center gap-2 bg-white/60 backdrop-blur-md border border-white/60 rounded-full px-4 py-2 mb-6 shadow-sm'>
          ...
          <div className='relative group w-full'>
            {/* Soft Multi-color Shadow behind card */}
            <div className='absolute -inset-1 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-violet-500/10 rounded-[2.5rem] blur-2xl opacity-100 transition-all duration-500 group-hover:opacity-100 group-hover:scale-[1.01]' />

            <div className='relative bg-white/60 backdrop-blur-xl border border-white/80 rounded-[2rem] p-8 md:p-12 lg:p-16 text-center shadow-2xl shadow-blue-900/5'>
              <h3 className='text-3xl md:text-4xl font-bold text-slate-900 mb-6'>
                Transform Your Vision Into Reality
              </h3>

              <p className='text-slate-600 text-lg mb-10 max-w-2xl mx-auto'>
                Get a free consultation and discover how we can help you achieve
                your digital goals with our expert team.
              </p>

              {/* Modern Button Group */}
              <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
                {/* Primary Button (Black - Consistent with Hero) */}
                <Link
                  href='/contact'
                  className='group inline-flex items-center justify-center gap-2 bg-slate-900 text-white font-bold px-8 py-4 rounded-xl transition-all duration-300 hover:bg-slate-800 hover:scale-105 active:scale-95 shadow-xl hover:shadow-2xl hover:shadow-slate-900/20 w-full sm:w-auto min-w-[200px]'
                >
                  Get Free Quote
                ...
                <button
                  onClick={scrollToPortfolio}
                  type='button'
                  className='group inline-flex items-center justify-center gap-2 bg-white text-slate-900 font-bold px-8 py-4 rounded-xl border border-slate-200 transition-all duration-300 hover:bg-slate-50 hover:border-slate-300 hover:scale-105 active:scale-95 w-full sm:w-auto min-w-[200px]'
                >
                  View Portfolio
                  <ArrowRight className='w-5 h-5 transition-transform duration-300 group-hover:translate-x-1' />
                </button>
