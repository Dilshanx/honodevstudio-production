    ...
    <footer className='relative w-full bg-[#E0F2FE] py-16 sm:py-20 lg:py-24 2xl:py-16 pb-24 xl:pb-16 overflow-hidden'>
      ...
      <div className='absolute inset-0 z-0 pointer-events-none'>
        ...
        {!shouldReduceMotion && (
          <motion.div
            style={{ x: dx, y: dy }}
            className='absolute top-[10%] right-[10%] w-[40%] h-[40%] bg-white/40 rounded-full blur-[100px]'
          />
        )}
        <div className='absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-indigo-200/40 rounded-full blur-[100px]' />
      ...
      <div className='container mx-auto px-4 md:px-8 lg:px-12 relative z-10'>
        ...
        >
          ...
          >
            ...
            <h2 className='font-bold text-[clamp(2.5rem,5vw,4rem)] leading-[0.9] text-slate-900 mb-6'>
              LET&apos;S BUILD
              <br />
            ...
            <p className='text-[clamp(1.1rem,2.5vw,1.3rem)] leading-relaxed text-slate-600 max-w-3xl mx-auto'>
              Ready to bring your ideas to life? We're just a message away.
            </p>
          </motion.div>

          {/* Main Grid: Reorganized for balance since CTA is removed */}
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 mb-16 lg:mb-24'>
            {/* Column 1: Contact Info */}
            <motion.div variants={itemVariants} className='space-y-8'>
              <h3 className='text-2xl md:text-3xl font-bold text-slate-900 mb-6 border-b border-slate-200 pb-4 inline-block'>
                Contact Information
              </h3>
            ...
            {/* Column 2: Social Links & Quick Links */}
            <motion.div variants={itemVariants} className='space-y-8'>
              <h3 className='text-2xl md:text-3xl font-bold text-slate-900 mb-6 border-b border-slate-200 pb-4 inline-block'>
                Connect With Us
              </h3>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                {socialLinks.map((link) => (
                  <motion.a
                    ...
                    href={link.href}
                    whileHover={
                      shouldReduceMotion ? {} : { scale: 1.05, y: -5 }
                    }
                    whileTap={shouldReduceMotion ? {} : { scale: 0.95 }}
                    className={`flex flex-col items-center justify-center p-6 rounded-2xl bg-gradient-to-br ${link.color} shadow-lg hover:shadow-xl transition-all duration-300 text-white`}
                    aria-label={link.name}
                  >
              ...
              {/* Quick Link box to balance layout */}
              <div className='p-6 rounded-2xl bg-white/40 border border-white/60 backdrop-blur-sm'>
                <p className='text-slate-600 text-sm mb-2'>
                  Need immediate assistance?
                </p>
                <a
                  href='tel:+94763923943'
