...
//           <div
//             className={`flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-[#E7FF1A] to-violet-400 group-hover:scale-110 transition-transform duration-300`}
//           >
