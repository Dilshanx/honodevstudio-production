...
// const Hero = () => {
//   const shouldReducedMotion = useReducedMotion(); // Corrected variable name

//   // Modern 2025 breakpoints and container queries approach
//   const containerVariants = {
//     hidden: { opacity: 0 },
//     visible: {
//       opacity: 1,
//       transition: {
//         staggerChildren: shouldReducedMotion ? 0 : 0.15,
//         delayChildren: shouldReducedMotion ? 0 : 0.3,
//       },
//     },
//   };

//   const itemVariants = {
//     hidden: shouldReducedMotion ? {} : { y: 20, opacity: 0 },
...
//   return (
//     // Changed min-h-[calc(...)] to h-[calc(...)] for exact height.
//     // Ensure that your HTML and Body have height: 100% and no default margins/padding.
...
//         <motion.div
//           initial={shouldReducedMotion ? {} : { scale: 1.05, opacity: 0.8 }}
//           animate={shouldReducedMotion ? {} : { scale: 1, opacity: 1 }}
//           transition={
//             shouldReducedMotion ? {} : { duration: 1.5, ease: "easeOut" }
//           }
...
//               }}
//               initial={shouldReducedMotion ? {} : { opacity: 0, y: 20 }}
//               animate={shouldReducedMotion ? {} : { opacity: 1, y: 0 }}
//               transition={
//                 shouldReducedMotion
//                   ? {}
...
//                 style={{
//                   // Enhanced fluid sizing with better minimum and maximum values
//                   width: "clamp(200px, 45vw, min(400px, 80vw))",
//                   height: "clamp(200px, 45vw, min(400px, 80vw))",
//                   // Ensure it never exceeds viewport constraints
//                   maxWidth: "min(90vw, 400px)",
//                   maxHeight: "min(50vh, 400px)",
//                 }}
//                 whileHover={shouldReducedMotion ? {} : { scale: 1.05 }}
//                 transition={
//                   shouldReducedMotion
//                     ? {}
...
//                 variants={itemVariants}
//                 style={{
//                   // Adjusted fluid typography for better scaling on very large devices
...
//                   }}
//                   whileHover={shouldReducedMotion ? {} : { scale: 1.02 }}
//                   whileTap={shouldReducedMotion ? {} : { scale: 0.98 }}
...
//               initial={shouldReducedMotion ? {} : { opacity: 0, x: 30 }}
//               animate={shouldReducedMotion ? {} : { opacity: 1, x: 0 }}
//               transition={
//                 shouldReducedMotion
//                   ? {}
//                   : { delay: 0.6, duration: 0.8, ease: "easeOut" }
//               }
//               // Removed fixed height/maxHeight here to allow aspect-video to control dimensions
//               // style={{
...
//               <motion.div
//                 // Added aspect-video class to maintain 16:9 aspect ratio
...
//               >
//                 <video
//                   className='w-full h-full object-cover' // object-cover will now work correctly within 16:9 container
...
//           initial={shouldReducedMotion ? {} : { opacity: 0, y: -10 }}
//           animate={shouldReducedMotion ? {} : { opacity: 1, y: 0 }}
//           transition={shouldReducedMotion ? {} : { delay: 1.2, duration: 0.6 }}
//         >
//           <motion.div
...
//             }}
//             animate={shouldReducedMotion ? {} : { y: [0, 4, 0] }}
//             transition={
//               shouldReducedMotion
//                 ? {}
...
//               }}
//               animate={shouldReducedMotion ? {} : { y: [0, 12, 0] }}
//               transition={
//                 shouldReducedMotion
//                   ? {}
//                   : { repeat: Infinity, duration: 2, ease: "easeInOut" }
