...
//     >
//       <div
//         className={`p-4 rounded-2xl bg-gradient-to-r ${gradient} group-hover:scale-110 transition-transform duration-200`}
//       >
...
//                 transition={
//                   shouldReduceMotion ? {} : { duration: 1.5, ease: "circOut" }
//                 }
